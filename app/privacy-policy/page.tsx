...
const PrivacyPolicyPage: React.FC = () => {
  return (
    <div className=" min-h-screen">
      <Head>
        <title>Privacy Policy - Breggo Electricals</title>
      </Head>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8">Privacy Policy of Breggo Electricals</h1>
        <div className="bg-white rounded-lg shadow-md p-6 lg:w-3/4 lg:mx-auto">
          <h2 className="text-xl font-semibold mb-4">Introduction</h2>
          <p className="mb-8 text-lg">
            Breggo Electricals operates the https://www.Breggo.store website, which provides the SERVICE. This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Breggo.store website.
          </p>
